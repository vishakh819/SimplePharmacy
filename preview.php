...
<body>
  ...
  <form method="POST" action="save_invoice.php">
  	<table class="table table-bordered table-hover" border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 20px;text-align:left;" width="100%">
      <tr>
    ...
    <tbody>
      ...
      ?>
        ...
        <td><h4><?php echo $row['category']; ?></h4></td>
        <td><h4><?php echo $row['qty']." (".$row['type'].")"; ?></h4>
      ...
      <?php endwhile;?>
        ...
        <tr>
          <td colspan="4" style=" text-align:right;"><strong style="font-size: 15px;">Total: &nbsp;</strong></td>
         ...
         <tr>
          <td colspan="4" style=" text-align:right;"><strong style="font-size: 15px;">Paid Amount: &nbsp;</strong></td>
          <td colspan="2"><strong style="font-size: 12px;">
          <?php
